            ...
            var Button = (function (_super) {
                ...
                Button.prototype.renderInput = function () {
                    ...
                    if (this.props.icon) {
                        ...
                        contents.push(React.createElement("span", {"className": "button-icon color-inversed-filled", "key": "icon"}, React.createElement("span", {"className": "button-icon-inside"}, this.renderIcon(this.props.icon))));
                    }
                    else {
                    ...
                    if (this.props.text) {
                        ...
                        contents.push(React.createElement("span", {"className": "button-text", "key": "text"}, React.createElement("span", {"className": "button-text-inside"}, this.props.text)));
                    }
                    else {
