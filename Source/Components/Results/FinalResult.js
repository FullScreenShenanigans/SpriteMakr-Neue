...
(function (SpriteMakr) {
    ...
    (function (Components) {
        ...
        (function (Results) {
             ...
             */
            var FinalResult = /** @class */ (function (_super) {
                ...
                FinalResult.prototype.renderSizing = function (width, height) {
                    return (React.createElement("span", { className: "result-info-sizing constant" },
                        React.createElement("span", { className: "sizing-constant" }, width),
                        "x",
                        React.createElement("span", { className: "sizing-constant" }, height)));
                };
                /**
                ...
                FinalResult.prototype.renderActions = function () {
                    return (React.createElement("span", { className: "result-no-actions constant" },
                ...
                FinalResult.prototype.renderSpriteData = function () {
                    return (React.createElement("span", { className: "result-info-sprite-parsed" },
                        React.createElement(Components.Inputs.TextInput, { defaultValue: this.props.initialSpriteInfo.imageConverted, readonly: true })));
                };
                return FinalResult;
            }(Results.Result));
